    ...
    <div className="flex h-screen">
      ...
      <div className="w-64 bg-blue-800 text-white p-6">
        ...
        <nav className="space-y-4">
          <a
            href="#home"
            className="block text-lg hover:text-indigo-300"
          ...
          <a
            href="#dataSecurity"
            className="block text-lg hover:text-indigo-300"
            onClick={() => setActiveSection("dataSecurity")}
          >
            链上数据安全管控
          </a>
          <a
            href="#nodeSecurity"
            className="block text-lg hover:text-indigo-300"
            onClick={() => setActiveSection("nodeSecurity")}
          >
            节点安全威胁检测
          </a>
          <a
            href="#securityConsensus"
            className="block text-lg hover:text-indigo-300"
            onClick={() => setActiveSection("securityConsensus")}
          >
            安全共识参数配置
          </a>
          <a
            href="#smartContractControl"
            className="block text-lg hover:text-indigo-300"
            onClick={() => setActiveSection("smartContractControl")}
          >
            智能合约访问控制
          </a>
          <a
            href="#situationAwareness"
            className="block text-lg hover:text-indigo-300"
            onClick={() => setActiveSection("situationAwareness")}
          >
            链上安全态势感知
          </a>
          <a
